...
// TODO Auto-generated method stub
    ...
    public ArrayList<String> getActividades(String carnet,String codPro){
        ...
        Cursor cr = db.rawQuery("select actividad from actividad,alumnoproyecto where carnet=? and codigoproyecto=? and alumnoproyecto.idactividad=actividad.idactividad",datos);
        while (cr.moveToNext()){
            listAct.add(cr.getString(0));
        }
        return listAct;
    }
    ...
    public int numHoras(String carnet){
        int numeroHoras=0;
        Cursor cursoNumHoras=db.rawQuery("select sum(numhoras) from actividad,alumnoproyecto where carnet =? and actividad.idactividad=alumnoproyecto.idactividad",new String[]{carnet});
