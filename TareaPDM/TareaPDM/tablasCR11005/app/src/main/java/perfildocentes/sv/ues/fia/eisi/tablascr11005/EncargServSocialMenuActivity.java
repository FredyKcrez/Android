...
public class EncargServSocialMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Eliminar Registro","Consultar Registro", "Actualizar Registro"};
    String[] activities={"EncargServSocialInsertarActivity","EncargServSocialEliminarActivity","EncargServSocialConsultarActivity ", "EncargServSocialActualizarActivity"};
    @Override
